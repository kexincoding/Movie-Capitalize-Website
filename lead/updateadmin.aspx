<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateadmin.aspx.cs" Inherits="lead_updateadmin" %>
...
&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="6" DataSourceID="SqlDataSource1" ForeColor="#333333" AllowPaging="True" AllowSorting="True" CellSpacing="3" DataKeyNames="adminid" Width="800px" GridLines="None" HorizontalAlign="Center" >
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="adminid" HeaderText="adminid" SortExpression="adminid" InsertVisible="False" ReadOnly="True" >
                </asp:BoundField>
                <asp:BoundField DataField="adname" HeaderText="adname" SortExpression="adname"  ItemStyle-Height="50" >
                </asp:BoundField>
                <asp:BoundField DataField="adpwd" HeaderText="adpwd" SortExpression="adpwd" HeaderStyle-Wrap="True" >
                </asp:BoundField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:movieConnection %>" SelectCommand="SELECT * FROM [admin]" DeleteCommand="delete from admin
