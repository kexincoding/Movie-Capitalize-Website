<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateuser.aspx.cs" Inherits="lead_updateuser" %>
    ...
    <td>
        ...
        <br /></div>
         ...
         <div style="width:300px; height:400px">
             ...
             <br />
             <br />          
             邮箱：<asp:TextBox type="text" runat="server" name="form-username"  class="form-username form-control" id="TextBox4" ></asp:TextBox>
             <br />
        <br />

                 
             <br />  
                      <asp:Button type="submit" runat="server" class="btn btn-skin pull-right" id="Button1" Text="修改" Height="43px"  Width="111px" BackColor="#FF9933" OnClick="Button1_Click"/>  
         </div>
