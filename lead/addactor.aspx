<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addactor.aspx.cs" Inherits="lead_addactor" %>
    ...
    <td>
        ...
        <br /></div>
         ...
         <div style="width:500px; height:400px">
             <asp:TextBox type="text" runat="server" name="form-username" placeholder="演员名" class="form-username form-control" id="name" ></asp:TextBox>
             <br />
             <asp:TextBox type="text" runat="server" name="form-username" placeholder="生日" class="form-username form-control" id="birthday" ></asp:TextBox>

             <br />

             <asp:TextBox type="int" runat="server" name="form-username" placeholder="性别" class="form-username form-control" id="gender" ></asp:TextBox>
            
              <br />
             地区：<asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="location" DataValueField="location">
             </asp:DropDownList>
       ...
       <br />
               ...
               <asp:TextBox name="评价"  Height="152px" TextMode="MultiLine"  id="message" runat="server"  Width="100%" class="form-control" rows="9" cols="25" required="required"
                                placeholder="简介"/>
             <br />  
                      <asp:Button type="submit" runat="server" class="btn btn-skin pull-right" id="Button1" Text="添加" Height="43px"  Width="111px" OnClick="Button1_Click"/>  
         </div>
