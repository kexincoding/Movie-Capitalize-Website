<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateactor1.aspx.cs" Inherits="lead_updateactor1" %>
    ...
    <td>
        ...
        <br /></div>
         ...
         <div style="width:500px; height:400px">
             ...
             <br />
              <asp:TextBox type="int" runat="server" name="form-username" placeholder="地区" class="form-username form-control" id="location" ></asp:TextBox>
             <br />
