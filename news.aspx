                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form id="form1" runat="server">
                                    ...
                                    <div class="form-group">
                                   &nbsp;&nbsp;&nbsp;<asp:Button ID="Button" type="submit" runat="server" class="btn" Text="登录" Height="60px" Width="230px" BackColor="#66CCFF" OnClick="Button_Click"/>
                                        &nbsp;&nbsp;&nbsp;
                                   <a href="register.aspx">没有账号？立即注册</a>
			                    </div>
                                      </form>
		                    </div>
                        </div>
